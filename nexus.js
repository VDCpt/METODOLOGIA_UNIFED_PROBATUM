/**
 * ============================================================================
 * UNIFED - PROBATUM · NEXUS LAYER · v13.5.1-MILITARY-HARDENED
 * ============================================================================
...
(function _nexusRAGJurisprudential() {
    ...
    function _buildJurisprudenceXML(analysis) {
        ...
        return [
            ...
            _hr(),
            _para('', false),
            _para('VI. JURISPRUDENCIA APLICAVEL — CRUZAMENTO RAG · NEXUS v13.5.1-MILITARY-HARDENED', true, '26', '003366'),
            ...
            _para(
                ...
                false, '20', '333333'),
            _para('', false),
            _para('[Secao gerada automaticamente pelo Modulo RAG Jurisprudencial — NEXUS v13.5.1-MILITARY-HARDENED · Art. 125.o CPP]', false, '16', '999999'),
            _para('', false)
        ].join('');
    }
    ...
    async function _openBlockchainExplorerModal() {
        ...
        var enriched = await Promise.all(registry.map(async function(item) {
            if (!item.hash) {
                ...
                item.otsStatus = 'PENDENTE — Hash gerado localmente (NEXUS v13.5.1-MILITARY-HARDENED)';
            }
            return item;
        }));
        ...
        overlay.innerHTML =
            ...
            '">' +
                ...
                '">' +
                    '<div>' +
                        '<div style="color:#00E5FF;font-size:0.85rem;font-weight:700;letter-spacing:0.08em">⛓️ BLOCKCHAIN EVIDENCE EXPLORER · NEXUS v13.5.1-MILITARY-HARDENED</div>' +
...
// ============================================================================
console.info(
    '%c[NEXUS · UNIFED-PROBATUM · v13.5.1-MILITARY-HARDENED]\n' +
...
/* =========================================================================
   FIM DO FICHEIRO NEXUS.JS · v13.5.1-MILITARY-HARDENED · UNIFED - PROBATUM
